...
import com.vista.react.R;
import com.vista.receiver.AudioBecomingNoisyReceiver;
import com.vista.receiver.BecomingNoisyListener;
...
class ReactExoplayerView extends FrameLayout implements
    ...
    public void showTracks(){
        ...
        if (!showTracks && TrackSelectionDialog.willHaveContent(trackSelector)) {
            showTracks = true;
            Activity activity = themedReactContext.getCurrentActivity();
            FragmentActivity activitys = (FragmentActivity) themedReactContext.getCurrentActivity();
            TrackSelectionDialog trackSelectionDialog =
                    TrackSelectionDialog.createForTrackSelector(
                            trackSelector,
                            /* onDismissListener= */ dismissedDialog -> showTracks = false);
            trackSelectionDialog.show(activitys.getSupportFragmentManager(), /* tag= */ null);
        }
    }
}
